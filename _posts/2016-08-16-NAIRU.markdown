...
var svg = d3.select("#d3-graph").append("svg").attr("width", width + margin.left + margin.right).attr("height", height + margin.top + margin.bottom).attr("viewBox", "0 "+"0 "+width + " " + height).attr("preserveAspectRatio", "xMidYMid meet");
